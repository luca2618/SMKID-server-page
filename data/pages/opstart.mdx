...
- **[Anmodningsskema til VPS](/opstart)**
...
1. Download og installer en VPN-klient (vi anbefaler **[OpenVPN connect](https://openvpn.net/client/)** eller en anden kompatibel VPN-klient).
