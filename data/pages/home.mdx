# Velkommen til SMKID Server Lab

Velkommen til hjemmesiden for SMKID’s server projekt! Her giver vi DTU-studerende en unik mulighed for at udforske og eksperimentere med serverinfrastruktur, netværk og avanceret teknologi gratis!

### Hvad er SMKID Server Lab?
...
Er du ny her? Begynd med at kigge på vores **[Kom i gang-guide](/opstart)**, hvor vi hjælper dig trin-for-trin med at få adgang til din egen server. Uanset om du vil prøve kræfter med webhosting, dataanalyse, AI eller netværksopsætning, så er vi her for at hjælpe dig i gang.
...
- **[FAQ](faq)** - Find svar på spørgsmål, guides og teknisk dokumentation.
- **[Projektidéer](projekter)** - Bliv inspireret til projekter, du kan starte.
